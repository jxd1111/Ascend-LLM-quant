...
- Quantization log:
  `/data/jxd/jxd-quant-results/w8a8-pdmix-toolkit-v030-quant.log`
- Runtime log:
...
The retained log identifies the evaluated artifact as
`/data/jxd/models/Qwen2.5-14B-Instruct-w8a8-pdmix-plugin`:
...
Raw log: `/data/jxd/jxd-quant-results/pdmix-plugin-ppl.log`.
...
zero failed requests. The logs identify served model `jxd-qwen25-pdmix` and
...
- `/data/jxd/jxd-quant-results/sharegpt/pdmix-plugin-rps1-c8.log`
- `/data/jxd/jxd-quant-results/sharegpt/pdmix-plugin-rps8-c80.log`
