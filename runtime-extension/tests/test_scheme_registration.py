...
def _load_scheme_module(monkeypatch):
    ...
    pdmix = types.ModuleType("vllm_ascend.quantization.methods.w8a8_pdmix")
    ...
    pdmix.AscendW8A8PDMixLinearMethod = type("NativeLinear", (), {})
    pdmix.AscendW8A8PDMixFusedMoeMethod = type("NativeMoe", (), {})
    ...
    module_name = "vllm_ascend_quant_ext.schemes.w8a8_pdmix"
